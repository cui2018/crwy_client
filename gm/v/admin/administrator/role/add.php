<form method="post" id="addRole">
  <table width="80%" align="center" border="0" cellpadding="0" cellspacing="1" class="tables">
    <tr class="title">
      <td align="center" colspan="2">角色添加</td>
    </tr>
    <tr>
      <td width="15%">角色名称：</td>
      <td><input type="text" id="rolename" name="rolename" class="input w160p"> <span id="rolename_error"></span></td>
    </tr>
    <tr>
      <td>角色拥有的权限：</td>
      <td>
    ...
    <tr>
      <td colspan="2">
        <input type="submit" value="添加角色" class="submitbtn">
