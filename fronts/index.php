...
define('WECHAT','test');
define('VERSION',TEST ? time() : 'f3.4.5');
define('VERSIONJS',TEST ? time() : 'j3.4.5');
...
//define('URL',(isset($_SERVER['REDIRECT_URL']) && $_SERVER['REDIRECT_URL'] == '/publickurl.html' ? 'http://' : 'https://') . SERVER_NAME . $_SERVER['REQUEST_URI']);
define('URL','http://' . SERVER_NAME . $_SERVER['REQUEST_URI']);
